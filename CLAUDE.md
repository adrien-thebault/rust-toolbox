...
```
{error, pagination} -> db -> cluster -> server -> {web, grpc}
```

| Crate                | Owns                                                                                                                                                                                                                                                                                                                                                            |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `toolbox-error`      | `ErrorKind`, `ServiceError`, `ErrorInfo`, RFC 9457 `Problem`. serde only                                                                                                                                                                                                                                                                                        |
| `toolbox-pagination` | `Page`/`PageRequest`/`Sort`. serde and thiserror only                                                                                                                                                                                                                                                                                                           |
