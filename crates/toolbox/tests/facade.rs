...
fn every_enabled_crate_is_reachable_under_its_short_name() {
    ...
    let _ = toolbox::error::ErrorKind::NotFound;
    ...
    let _ = toolbox::web::status_for(toolbox::error::ErrorKind::NotFound);
    let _ = toolbox::grpc::code_for(toolbox::error::ErrorKind::NotFound);
}
