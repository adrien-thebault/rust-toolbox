...
| [`toolbox-macros`](crates/toolbox-macros/README.md)         | the `#[derive(Entity)]` and `#[derive(ServiceError)]` proc macros                                    |
...
| [`toolbox-schedule`](crates/toolbox-schedule/README.md)     | cluster-safe scheduled tasks, exclusive by default, and the clock port                               |
...
| [`toolbox-test`](crates/toolbox-test/README.md)             | throwaway databases, an in-process gateway, a gRPC cluster, problem assertions; dev-only             |
